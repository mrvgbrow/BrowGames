...
def scale_parameters():
    global PADDLE_RADIUS,BALL_SPEED,PLAYER_MOVESTEP,TICK_FRAMERATE,BALL_SPEED_INCREASE,BALL_MAX_SPEED,WALL_WIDTH,SCORE_YPOS,SCREEN_WIDTH,SCREEN_HEIGHT,PADDLE_LIMIT,WALL_LENGTH,PADDLE_LENGTH,PADDLE_WIDTH,SCREEN_PAD,PADDLE_WALL_OFFSET,SCORE_SIZE
    ...
    PADDLE_LIMIT=SCREEN_PAD
    SCORE_SIZE*=SCREEN_HEIGHT
